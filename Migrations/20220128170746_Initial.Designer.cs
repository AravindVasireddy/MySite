...
namespace AVPatients.Migrations
{
    ...
    [Migration("20220128170746_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AVPatients.Models.ConcentrationUnit", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.Diagnosis", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.DiagnosisCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("AVPatients.Models.DispensingUnit", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.Medication", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.MedicationType", b =>
                {
                    b.Property<int>("MedicationTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("medicationTypeId")
            ...
            modelBuilder.Entity("AVPatients.Models.Patient", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.PatientDiagnosis", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.PatientMedication", b =>
                {
            ...
            modelBuilder.Entity("AVPatients.Models.PatientTreatment", b =>
                {
                    b.Property<int>("PatientTreatmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("patientTreatmentId")
            ...
            modelBuilder.Entity("AVPatients.Models.Province", b =>
                {
                    b.Property<string>("ProvinceCode")
                        .HasColumnName("provinceCode")
                        .HasColumnType("char(2)")
            ...
            modelBuilder.Entity("AVPatients.Models.Treatment", b =>
                {
                    b.Property<int>("TreatmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("treatmentId")
            ...
            modelBuilder.Entity("AVPatients.Models.TreatmentMedication", b =>
                {
                    b.Property<int>("TreatmentId")
                        .HasColumnName("treatmentId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AVPatients.Models.Diagnosis", b =>
                {
                    b.HasOne("AVPatients.Models.DiagnosisCategory", "DiagnosisCategory")
                        .WithMany("Diagnosis")
            ...
            modelBuilder.Entity("AVPatients.Models.Medication", b =>
                {
                    b.HasOne("AVPatients.Models.ConcentrationUnit", "ConcentrationCodeNavigation")
                        .WithMany("Medication")
                        .HasForeignKey("ConcentrationCode")
                        .HasConstraintName("FK_medication_concentrationUnit")
                        .IsRequired();

                    b.HasOne("AVPatients.Models.DispensingUnit", "DispensingCodeNavigation")
                        .WithMany("Medication")
                        .HasForeignKey("DispensingCode")
                        .HasConstraintName("FK_medication_dispensingUnit")
                        .IsRequired();

                    b.HasOne("AVPatients.Models.MedicationType", "MedicationType")
                        .WithMany("Medication")
            ...
            modelBuilder.Entity("AVPatients.Models.Patient", b =>
                {
                    b.HasOne("AVPatients.Models.Province", "ProvinceCodeNavigation")
                        .WithMany("Patient")
            ...
            modelBuilder.Entity("AVPatients.Models.PatientDiagnosis", b =>
                {
                    b.HasOne("AVPatients.Models.Diagnosis", "Diagnosis")
                        .WithMany("PatientDiagnosis")
                        .HasForeignKey("DiagnosisId")
                        .HasConstraintName("FK_patientDiagnosis_diagnosis")
                        .IsRequired();

                    b.HasOne("AVPatients.Models.Patient", "Patient")
                        .WithMany("PatientDiagnosis")
            ...
            modelBuilder.Entity("AVPatients.Models.PatientMedication", b =>
                {
                    b.HasOne("AVPatients.Models.Medication", "DinNavigation")
                        .WithMany("PatientMedication")
                        .HasForeignKey("Din")
                        .HasConstraintName("FK_patientMedication_medication")
                        .IsRequired();

                    b.HasOne("AVPatients.Models.PatientTreatment", "PatientTreatment")
                        .WithMany("PatientMedication")
            ...
            modelBuilder.Entity("AVPatients.Models.Province", b =>
                {
                    b.HasOne("AVPatients.Models.Country", "CountryCodeNavigation")
                        .WithMany("Province")
