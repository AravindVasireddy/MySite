...
{
    public class AVDispensingUnitController : Controller
    {
        private readonly PatientsContext _context;

        public AVDispensingUnitController(PatientsContext context)
        {
            _context = context;
        }

        // GET: AVDispensingUnit
        public async Task<IActionResult> Index()
        {
            return View(await _context.DispensingUnit.ToListAsync());
        }

        // GET: AVDispensingUnit/Details/5
        ...
        // GET: AVDispensingUnit/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AVDispensingUnit/Create
        ...
        // POST: AVDispensingUnit/Delete/5
