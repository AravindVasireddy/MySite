...
{
    public class AVMedicationTypeController : Controller
    {
        private readonly PatientsContext _context;

        // Constructor of the Controller class
        public AVMedicationTypeController(PatientsContext context)
        {
            _context = context;
        }

        // GET: AVMedicationType
        ...
        // GET: AVMedicationType/Details/5
        ...
        // POST: AVMedicationType/Delete/5
